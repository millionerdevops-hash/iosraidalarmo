...
import { ServerMapTab } from './ServerMapTab';
import { ServerLiveTab } from './ServerLiveTab';
import { ServerTargetsTab } from './ServerTargetsTab';
    ...
    return (
        <div className="flex flex-col h-full bg-[#0c0c0e] relative">
            ...
            <ServerHeader 
                ...
                onNavigate={onBack} // Not ideal but using onBack as nav to search
            />
            ...
            <div className="flex-1 overflow-y-auto p-4">
                {activeTab === 'OVERVIEW' && (
                    <ServerOverviewTab 
                        ...
                        // Important: Passing Paywall trigger. 
                        // In a real app we'd pass userRole prop down. For now assuming free for demo of lock.
                        // Ideally ServerDetailManager gets userRole from App.tsx
                        // I will hack it here: if wipeAlertEnabled is false, user is treated as potentially Free when toggling.
                        // But wait, we didn't pass userRole to ServerDetailManager in App.tsx. 
                        // I need to update App.tsx to pass it down properly.
                        // Since I can't edit App.tsx again in this block, I'll rely on the default prop in ServerOverviewTab.
                    />
                )}
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-2 duration-300">
                        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-center">
                            ...
                            <div className="text-3xl font-black text-white font-mono tracking-tighter">
                                {/* Re-implement formatCountdown logic locally or import */}
                                --
                            </div>
                        </div>
                    </div>
