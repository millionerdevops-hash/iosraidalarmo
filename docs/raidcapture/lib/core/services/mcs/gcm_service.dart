...
class GcmService {
  ...
  Future<Map<String, dynamic>> checkIn({int androidId = 0, int securityToken = 0}) async {
    debugPrint("Starting GCM Check-in...");
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint("Android ID: ${checkinResp.androidId}");
      debugPrint("Security Token: ${checkinResp.securityToken}");
      return {
  ...
  Future<String> register(int androidId, int securityToken) async {
    debugPrint("Starting GCM Registration...");
