...
class RustColors {
  ...
  static const Color warning = Color(0xFFF97316);       // orange-500 (accent ile aynı)
  static const Color info = Color(0xFF3B82F6);          // blue-500
  
  // Glow Colors (for shadow effects)
  static const Color glowRed = Color(0xFFDC2626);       // primary
  static const Color glowOrange = Color(0xFFF97316);    // accent
}
